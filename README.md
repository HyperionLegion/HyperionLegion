...
const JoshuaHsueh = {
  ...
  tools: [ReactJS, NextJS, VueJS, ElectronJS, NodeJS, REST APIs, GraphQL, PostgreSQL, MongoDB, TailwindCSS, Android Studio, Redis, AWS, Google Cloud, Firebase, Supabase, Linux, Git],
